...
(async function () {
    ...
    try {
        ...
        if (status == 200) {
            document.getElementById('delete_my_account_btn')!.addEventListener('click', async (e: Event) => {
            ...
            document.getElementById('undelete_my_account_btn')!.addEventListener('click', async (e: Event) => {
    ...
    document.getElementById('dataprivacy_form')!.addEventListener('change', async (e: Event) => {
