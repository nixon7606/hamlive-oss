...
(async function () {
    ...
    document.getElementById('magic-auth')!.addEventListener('submit', async (e: Event) => {
        e.preventDefault();

        const inputElem = (e.target as HTMLFormElement).querySelector('input') as HTMLInputElement;
